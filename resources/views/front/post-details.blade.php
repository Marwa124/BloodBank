...
<?php $posts =  App\Models\Post::take(9)->get();?>
  ...
  <div class="container">
      ...
      <div class="article-content my-4">
          <div class="article-header p-2 d-flex justify-content-between">
              <h6>{{$post->title}}</h6>
              <a href=""><i id="{{$post->id}}" class="far fa-heart {{$post->is_favorite ? 'fas' : 'far'}}"></i></a>
          </div>
                  ...
                  <div class="slick-cont">
                      <div class="card">
                          ...
                          <div class="card-body">
                              ...
                              <p>{{$post->content}}</p>
                              <div class="text-center"><a href="{{route('post.details', $post->id)}}" class="btn bg px-5">التفاصيل</a></div>
                          </div>
                      </div>
                  </div>
                @endforeach
