      ...
      <div class="Status-info p-3 my-4">
          <div class="row">
              <div class="col-md-6 clearfix">
                  ...
                  <p class="status-item float-right p-3">أحمد محمد</p>
              </div>
              <div class="col-md-6 clearfix">
                  <p class="status float-right p-3">فصيلة الدم</p>
                  <p class="status-item float-right p-3">A+</p>
              </div>
              <div class="col-md-6 clearfix">
                  <p class="status float-right p-3">العمر</p>
                  <p class="status-item float-right p-3">28</p>
              </div>
              <div class="col-md-6 clearfix">
                  <p class="status float-right p-3">عدد الأكياس المطلوبة</p>
                  <p class="status-item float-right p-3">3 أكياس</p>
              </div>
              <div class="col-md-6 clearfix">
                  <p class="status float-right p-3">المشفى</p>
                  <p class="status-item float-right p-3">الخير الدولية</p>
              </div>
              <div class="col-md-6 clearfix">
                  <p class="status float-right p-3">رقم الجوال</p>
                  <p class="status-item float-right p-3">0245487878</p>
              </div>
          </div><!--End row-->
